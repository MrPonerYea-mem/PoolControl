...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query("select new mem.MrPonerYea.PoolControl.model.dto.UserResponseDto(g.instructor.username as username, " +
            ...
            ":start between g.instructor.timeStart and g.instructor.timeEnd " +
            "group by username, timeToWork " +
            "order by timeToWork")
    List<UserResponseDto> getListInstructorFilter(@Param("date") Date date, @Param("start") LocalTime start);
